...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--plan-methods", default="", help="Comma list among lora,selective_ft,relora (empty=all).")
    ...
    p.add_argument("--plan-relora-merge-freqs", default="", help="Comma list of ReLoRA merge frequencies to include (empty=all).")
